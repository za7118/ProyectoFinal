...
<H1 style="position: relative;top: 10px;font-size: 55px;font-weight: bold;font-family: algerian;color:blue;">Modificar maestro</h1>    
<p style="position: relative;top: 3%;font-size: 20px;font-weight: bold;">Ingresa los datos</p> 
<br>
    ...
    <ul class="nav nav-tabs">
      <li class="nav-item">
        <a href="#account" class="nav-link active" data-toggle="tab">
          <i class="fa fa-lock mr-2"></i>Datos maestro(a)
        </a>
      </li>
    </ul>
