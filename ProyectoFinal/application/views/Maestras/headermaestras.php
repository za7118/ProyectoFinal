    ...
    <div class="collapse navbar-collapse" id="navbarColor01" >
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active" style="">
          <a class="nav-link" href="maestra"style="color: #FFFFFF;padding-left: 20px;padding-right: 5px;">Inicio<span></span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Subircalificaciones" style="color: #FFFFFF;padding-left: 20px;padding-right: 5px;">Calificaciones</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Subiravisos" style="color: #FFFFFF;padding-left: 20px;padding-right: 5px;">Avisos</a>
        </li>
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="Nuevoalumno">Agregar nuevo alumno</a>
          <a class="dropdown-item" href="Modificaralumno">Modificar información alumno</a>
          <a class="dropdown-item" href="Bajaalumno">Dar de baja alumno</a>
        </div>
      </li>
