...
<H1 style="position: relative;top: 10px;font-size: 60px;font-weight: bold;font-family: algerian;color:blue;">Bienvenido</h1>
  ...
  <div class="carousel-inner" style="position: relative;top: 70px;">
    <div class="carousel-item active">
      <img src="http://localhost/pagina/imagenes/imss2.jpg" class="d-block w-100" alt="..." style="width: 80%;height: 200px;">
    </div>
    <div class="carousel-item">
      <img src="http://localhost/pagina/imagenes/fondoj.jpg" class="d-block w-100" alt="..." style="width: 80%;height: 250px;">
    </div>
    <div class="carousel-item">
      <img src="http://localhost/pagina/imagenes/personal.jpg" class="d-block w-100" alt="..." style="width: 80%;height: 250px;">
    </div>
  </div>
